...
import { Account, AccountPopoverFooter, AccountPreview, SignOutButton, type AccountPreviewProps } from '@toolpad/core';
import { Avatar, Divider, ListItemIcon, ListItemText, MenuItem, MenuList, Stack } from '@mui/material';
...
function useToolpadRouter(): Router {
	...
	const pathname = location.pathname.replace(/^\/frontend/, '') || '/';
	...
	return (
		...
		<DemoProvider window={demoWindow}>
			...
			<AppProvider
				...
				session={session}
				branding={{
    				logo: <img src="./images/FlyTopia.png" alt="FlyTopia logo" />,
    				title: 'Fly Topia',
    				homeUrl: '/home',
  				}}
			>
